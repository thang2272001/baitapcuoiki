<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#F89053">9 Orange</h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2021-Nhom11 <a href="#" style="color:red"> 9-Orange </a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
